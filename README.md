...
The browser demo requires explicit consent and microphone permission and refreshes dashboard data shortly after a call ends. Never expose the Vapi private key in the browser or in these variables.
